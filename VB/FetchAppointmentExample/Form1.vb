...
Namespace FetchAppointmentExample
    Partial Public Class Form1
        ...
        Private Sub schedulerDataStorage1_FetchAppointments(ByVal sender As Object, ByVal e As FetchAppointmentsEventArgs)
        ...
        Private Sub CreateSampleData()
            SchedulerHelper.FillResources(Me.schedulerDataStorage1, 17)
            Me.resourcesTableAdapter.Update(scheduleTestDataSet)
            SchedulerHelper.GenerateAppointments(Me.schedulerDataStorage1, 150)
        ...
        Private Sub cbFetchAppointments_CheckedChanged(ByVal sender As Object, ByVal e As EventArgs) Handles cbFetchAppointments.CheckedChanged
            If cbFetchAppointments.Checked Then
                AddHandler schedulerDataStorage1.FetchAppointments, AddressOf schedulerDataStorage1_FetchAppointments
            Else
                RemoveHandler schedulerDataStorage1.FetchAppointments, AddressOf schedulerDataStorage1_FetchAppointments
                Me.resourcesTableAdapter.Fill(scheduleTestDataSet.Resources)
                Me.appointmentsTableAdapter.Fill(scheduleTestDataSet.Appointments)
            End If
        End Sub
