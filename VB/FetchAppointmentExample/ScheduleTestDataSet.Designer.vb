...
Namespace FetchAppointmentExample.ScheduleTestDataSetTableAdapters
    ...
    Public Partial Class AppointmentsTableAdapter
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(CInt((1))).CommandText = "SELECT       Appointments.*" & Global.Microsoft.VisualBasic.Constants.vbCrLf & "FROM         Appointments" & Global.Microsoft.VisualBasic.Constants.vbCrLf & "WHERE        (StartDate >= @From) AND (StartDate <= @To) OR" & Global.Microsoft.VisualBasic.Constants.vbCrLf & "                     (EndDate >= @From) AND (EndDate <= @To) OR" & Global.Microsoft.VisualBasic.Constants.vbCrLf & "                     (StartDate < @From) AND (EndDate > @To) OR" & Global.Microsoft.VisualBasic.Constants.vbCrLf & "                     (Type != 0)"
