    ...
    Public Partial Class ScheduleTestDataSet
        ...
        Public Partial Class ResourcesDataTable
            ...
            Public Function FindByUniqueID(ByVal UniqueID As Integer) As ResourcesRow
                Return CType((Me.Rows.Find(New Object() {UniqueID})), FetchAppointmentExample.ScheduleTestDataSet.ResourcesRow)
            End Function
...
Namespace FetchAppointmentExample.ScheduleTestDataSetTableAdapters
    ...
    Public Partial Class AppointmentsTableAdapter
        ...
        Private Sub InitConnection()
            ...
            Me._connection.ConnectionString = Global.FetchAppointmentExample.Properties.Settings.[Default].ScheduleTestConnectionString1
        End Sub
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(CInt((1))).Connection = New Global.System.Data.SqlClient.SqlConnection(Global.FetchAppointmentExample.Properties.Settings.[Default].ScheduleTestConnectionString1)
            Me._commandCollection(CInt((1))).CommandText = "SELECT       Appointments.*" & Global.Microsoft.VisualBasic.Constants.vbCrLf & "FROM         Appointments" & Global.Microsoft.VisualBasic.Constants.vbCrLf & "WHERE        (StartDate >= @From) AND (StartDate <= @To) OR" & Global.Microsoft.VisualBasic.Constants.vbCrLf & "                     (EndDate >= @From) AND (EndDate <= @To) OR" & Global.Microsoft.VisualBasic.Constants.vbCrLf & "                     (StartDate < @From) AND (EndDate > @To) OR" & Global.Microsoft.VisualBasic.Constants.vbCrLf & "                     (Type = 1);" & Global.Microsoft.VisualBasic.Constants.vbCrLf
            Me._commandCollection(CInt((1))).CommandType = Global.System.Data.CommandType.Text
            Me._commandCollection(CInt((1))).Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@From", Global.System.Data.SqlDbType.SmallDateTime, 4, Global.System.Data.ParameterDirection.Input, 0, 0, "StartDate", Global.System.Data.DataRowVersion.Current, False, Nothing, "", "", ""))
            Me._commandCollection(CInt((1))).Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@To", Global.System.Data.SqlDbType.SmallDateTime, 4, Global.System.Data.ParameterDirection.Input, 0, 0, "StartDate", Global.System.Data.DataRowVersion.Current, False, Nothing, "", "", ""))
        End Sub
        ...
        Public Overridable Function FillBy(ByVal dataTable As FetchAppointmentExample.ScheduleTestDataSet.AppointmentsDataTable, ByVal From As Global.System.Nullable(Of Global.System.DateTime), ByVal [To] As Global.System.Nullable(Of Global.System.DateTime)) As Integer
            Me.Adapter.SelectCommand = Me.CommandCollection(1)
            If(From.HasValue = True) Then
                Me.Adapter.SelectCommand.Parameters(CInt((0))).Value =(CDate((From.Value)))
            Else
                Me.Adapter.SelectCommand.Parameters(CInt((0))).Value = Global.System.DBNull.Value
            End If

            If([To].HasValue = True) Then
                Me.Adapter.SelectCommand.Parameters(CInt((1))).Value =(CDate(([To].Value)))
            Else
