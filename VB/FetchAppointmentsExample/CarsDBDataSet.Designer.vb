...
Namespace CarsDBDataSetTableAdapters
    ...
    Partial Public Class CarSchedulingTableAdapter
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(1).CommandText = "SELECT * "&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM CarScheduling "&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"WHERE ((StartTime >= :From) AND (StartTime <= :To"& _ 
                ")) "&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"OR ((EndTime >= :From)  AND (EndTime <= :To)) "&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"OR ((StartTime < :From) AND"& _ 
                " (EndTime > :To)) "&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"OR (EventType = 1)"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)
            Me._commandCollection(1).CommandType = Global.System.Data.CommandType.Text
            Me._commandCollection(1).Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("From", Global.System.Data.OleDb.OleDbType.DBTimeStamp, 0, Global.System.Data.ParameterDirection.Input, CType(0,Byte), CType(0,Byte), Nothing, Global.System.Data.DataRowVersion.Current, false, Nothing))
            Me._commandCollection(1).Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("To", Global.System.Data.OleDb.OleDbType.DBTimeStamp, 0, Global.System.Data.ParameterDirection.Input, CType(0,Byte), CType(0,Byte), Nothing, Global.System.Data.DataRowVersion.Current, false, Nothing))
        End Sub
        ...
        Public Overloads Overridable Function FillBy(ByVal dataTable As CarsDBDataSet.CarSchedulingDataTable, ByVal From As Date, ByVal _To As Date) As Integer
        ...
        Public Overloads Overridable Function GetDataBy(ByVal From As Date, ByVal _To As Date) As CarsDBDataSet.CarSchedulingDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(1)
            Me.Adapter.SelectCommand.Parameters(0).Value = CType(From,Date)
            Me.Adapter.SelectCommand.Parameters(1).Value = CType(_To,Date)
            Dim dataTable As CarsDBDataSet.CarSchedulingDataTable = New CarsDBDataSet.CarSchedulingDataTable()
